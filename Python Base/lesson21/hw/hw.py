                ...
                <div class="col-4">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="w-100 p-3 btn btn-success btn-lg">Купить
                            </button>
                        </div>
                    </div>
                </div>
                <div class="col-4">
                    <div class="card mb-4 rounded-3 shadow-sm form-control">
                        <div class="card-body">
                            <form>
                                <div class="mb-3">
                ...
                <div class="col-16">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <p class="d-inline-flex gap-1">
                            <a class="w-100 p-3 btn btn-primary" data-bs-toggle="collapse" href="#multiCollapseExample1"
                               role="button"
                               aria-expanded="false" aria-controls="multiCollapseExample1">Как купить?</a>
                            <button class="w-100 p-3 btn btn-primary" type="button" data-bs-toggle="collapse"
